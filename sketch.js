...
let menuTargets = [
	'https://waittttt-dot.github.io/20251115/', // 第一單元作品
	'https://hackmd.io/@LVm_IqBXRVCOxapAxm1GhQ/r1VxPmCixl', // 第一單元講義
	'https://waittttt-dot.github.io/20251113/', // 測驗系統
	'https://hackmd.io/@LVm_IqBXRVCOxapAxm1GhQ/S1Nft1Hebg', // 測驗卷筆記
...
function drawStudentInfo() {
    push();
    // 設定文字樣式
    const studentInfoText = '班級: 教育科技一年B班   姓名: 劉O宇   學號: 414730522';
    const padding = 10;
    textSize(20);
